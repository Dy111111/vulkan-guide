...
void VulkanEngine::init_swapchain()
{
    ...
    _drawExtent = { drawImageExtent.width, drawImageExtent.height };
...
void VulkanEngine::init()
{
    ...
    _mainDeletionQueue.push_function([this]() { vmaDestroyAllocator(_allocator); });
    init_swapchain();
    init_commands();
...
void VulkanEngine::cleanup()
{
    if (_isInitialized) {
        ...
        // The draw image and VMA allocator depend on VkDevice, so they must be
        // released before destroying the device.
